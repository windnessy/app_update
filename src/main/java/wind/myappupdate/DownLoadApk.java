...
public class DownLoadApk {
    ...
    public static void download(Context context, String url, String title,final String appName, boolean flag) {
        // 获取存储ID
      /*  SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        start(context, url, title,appName, flag);
    }

    private static void start(Context context, String url, String title,String appName, boolean flag) {
        long id = FileDownloadManager.getInstance(context).startDownload(url,
                title, "下载完成后点击打开",appName, flag);
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
